...
$templateParameterUri = $githubHandle + 'csa_master_class/master/IaaS%20Essentials/VNET-and-Subnet/VNET-Peering.parameters.json'


 New-AzureRmResourceGroupDeployment -Name "VNET-Peering-Deployment" -ResourceGroupName $resourceGroupName -Mode Incremental `
 ...
 New-AzureRmResourceGroupDeployment -Name "VNET-Peering-Deployment"  -ResourceGroupName 'm1-AzureIaaSEssentials' -Mode Incremental `
 -TemplateFile "C:\Users\aisadmin\Source\Repos\csa_master_class\IaaS Essentials\VNET-and-Subnet\VNET-Peering.json" `
 -TemplateParameterFile "C:\Users\aisadmin\Source\Repos\csa_master_class\IaaS Essentials\VNET-and-Subnet\VNET-Peering.parameters.json" -Verbose
 #>