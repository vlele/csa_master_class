...
$templateParameterUri = $githubHandle + 'csa_master_class/master/M1/VNET-and-Subnet/VNET-Peering.parameters.json'
 ...
 -TemplateParameterFile "C:\Users\aisadmin\Source\Repos\csa_master_class\M1\VNET-and-Subnet\VNET-Peering.parameters.json" -Verbose
 #>